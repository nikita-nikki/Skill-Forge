...
const getEnrolledTracks = asyncHandler(async (req, res) => {
    ...
    const tracks = enrollments.map(e => e.track).filter(t => t !== null);

    return res.status(200).json(
        new ApiResponse(200, tracks, "Enrolled tracks fetched successfully.")
    );
});
